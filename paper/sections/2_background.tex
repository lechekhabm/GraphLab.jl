...
% \begin{document}
    Consider a mesh consisting of eight cells, as illustrated in \Cref{fig:meshgraph}.
   ...
   Finding an optimal solution is NP-hard for this bisection problem, making the exact computation intractable for large instances~\cite{buluc2015recentadvancesgraphpartitioning}. In the following,
    ...
    As an example, for the mesh and the corresponding graph depicted in \Cref{fig:meshgraph}, the adjacency matrix $\mathbf{A}$ and the degree matrix $\mathbf{D}$ are given as follows:
