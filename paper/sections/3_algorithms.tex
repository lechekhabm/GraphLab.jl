...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    $Z_i \in \mathcal{S}^d$, via stereographic projection.
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    \caption{Spectral embedding and random sphere partitioning: the graph is first embedded into a 2-dimensional
