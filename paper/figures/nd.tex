\begin{figure}[h]
    ...
    \caption{Comparison of the (a) original adjacency matrix of the \texttt{3elt}~\cite{10.1145/2049662.2049663} graph against three nested dissection reoderings obtained using (b) coordinate, (c) inertial,  and (d) spectral-based separators. Number of nonzeros (nnz) in the Cholesky factor are reported in the subcaptions.}
